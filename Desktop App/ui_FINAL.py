...
################################################################################
## Form generated from reading UI file 'indextheend.ui'
##
...
"}")
        ...
        self.studentInfo_table.horizontalHeader().setStretchLastSection(True)
        ...
        self.layoutWidget3.setGeometry(QRect(31, 97, 764, 37))
...
"}")
        ...
        self.horizontalLayout_4.addWidget(self.addStudent_button)

        self.removeStudentBtn = QPushButton(self.layoutWidget3)
        self.removeStudentBtn.setObjectName(u"removeStudentBtn")
        self.removeStudentBtn.setMinimumSize(QSize(0, 35))
        self.removeStudentBtn.setMaximumSize(QSize(16777215, 35))
        self.removeStudentBtn.setStyleSheet(u"QPushButton{\n"
"	background-color: #af8501;\n"
"	color: #ffffff;\n"
"	border-radius: 5px;\n"
"	border: none;\n"
...
"}")
        ...
        self.removeStudentBtn.setIcon(icon12)

        self.horizontalLayout_4.addWidget(self.removeStudentBtn)
...
"}")
        ...
        self.horizontalLayout_4.addWidget(self.select_gender)
...
"}")
        ...
        self.horizontalLayout_4.addWidget(self.select_class)
...
"}")
        ...
        self.horizontalLayout_4.addWidget(self.search_student)
        ...
        if (self.studentInfo_table_2.columnCount() < 6):
            self.studentInfo_table_2.setColumnCount(6)
        ...
        self.studentInfo_table_2.setHorizontalHeaderItem(5, __qtablewidgetitem20)
        ...
        self.studentInfo_table_2.setGeometry(QRect(50, 200, 691, 211))
...
"}")
        icon13 = QIcon()
        icon13.addFile(u":/Icons/ad-blocker (2).png", QSize(), QIcon.Normal, QIcon.Off)
        self.addStudent_button_2.setIcon(icon13)
        ...
        self.violence_reoprts_table.setGeometry(QRect(240, 170, 421, 231))
...
"}")
        ...
        self.violence_reoprts_table.horizontalHeader().setDefaultSectionSize(200)
        self.violence_reoprts_table.horizontalHeader().setStretchLastSection(True)
        self.violence_reoprts_table.verticalHeader().setVisible(False)
        self.violence_reoprts_table.verticalHeader().setHighlightSections(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.removeStudentBtn.setText(QCoreApplication.translate("MainWindow", u"Remove Student", None))
        ...
        ___qtablewidgetitem20 = self.studentInfo_table_2.horizontalHeaderItem(5)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"Uniform checking", None));
        ...
        ___qtablewidgetitem28.setText(QCoreApplication.translate("MainWindow", u"Video", None));
