...
def DetectYacta():
    ...
    #MoBiLSTM_model = load_model('model mobile net accyracy 94.61 data sahel 163 video.h5')
    #MoBiLSTM_model = load_model('dense121-40 frame-version2.h5')
    MoBiLSTM_model = load_model('D:\Hena_Version\SchoolFinal1\loss 1646.h5')
    ...
    def predict_video(video_file_path):
        ...
        output_directory_vio = f'D:\Hena_Version\SchoolFinal1\Violence_Incidences'
        ...
        if predicted_class_name=="Violence":
            pygame.mixer.init()
            pygame.mixer.music.load("D:\Hena_Version\SchoolFinal1\cyber-alarms-synthesized-116358.mp3")
    ...
    output_directory = 'D:\Hena_Version\SchoolFinal1\my_videos'
    os.makedirs(output_directory, exist_ok=True)
